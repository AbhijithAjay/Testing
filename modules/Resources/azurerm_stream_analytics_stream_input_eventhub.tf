resource "azurerm_stream_analytics_stream_input_eventhub" "euclid" {
  name                         = var.azurerm_stream_analytics_stream_input_eventhub-name
  ...
  shared_access_policy_name    = var.azurerm_stream_analytics_stream_input_eventhub-shared_access_policy_name

  serialization {
    type     = var.azurerm_stream_analytics_stream_input_eventhub-serialization_type
    encoding = var.azurerm_stream_analytics_stream_input_eventhub-serialization_encoding
  }
}