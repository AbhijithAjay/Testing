resource "azurerm_stream_analytics_output_eventhub" "euclid" {
  name                      = var.azurerm_stream_analytics_output_eventhub-name
  ...
  shared_access_policy_name = var.azurerm_stream_analytics_output_eventhub-shared_access_policy_name

  serialization {
    type = var.azurerm_stream_analytics_output_eventhub-serialization_type
  }
}