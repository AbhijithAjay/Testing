variable "name" {default = "euclid_azurerm_hdinsight_interactive_query_cluster"}
variable "resource_group_name" {default = "azurerm_resource_group.example.name"}
variable "location" {default = "azurerm_resource_group.example.location"}
variable "cluster_version" {default = "3.6"}
variable "tier" {default = "Standard"}
variable "interactive_hive" {default = "azurerm_hdinsight_hbase_cluster"}
...
variable "roles_vm_size" {default = "Standard_D13_V2"}
variable "roles_username" {default = "acctestusrvm"}
variable "roles_password" {default = "AccTestvdSC4daf986!"}
variable "worker_node_vm_size" {default = "Standard_D14_V2"}
...
variable "zookeeper_node_vm_size" {default = "Standard_A4_V2"}
